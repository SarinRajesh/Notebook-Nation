    ...
    <div class="container-fluid">
      ...
      <div class="row mt-3" style="margin-right:-1207.5px">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
            <form action="records_delivery_boy.php" method="post">
            ...
            while($row=mysqli_fetch_array($result))
            {
                $_SESSION['id']=$row['id'];
                     ...
                     <?php if ($row['file']==NULL) {
                      ...
                      <td> <button class="btn btn-danger"><?php echo "<a href='dashboard_boystatus.php?id=$row[id]'>Deactivate</a>"?></button></td>
                      <?php } else {
                        ?><td style="color:red"><?php echo $row['status'];?></td>
                       <td> <button class="btn btn-success"><?php echo "<a href='dashboard_boystatus.php?id=$row[id]'>Activate</a>"?></button></td>
                      <?php }
                      ?>
                    </tr>
                    <?php
