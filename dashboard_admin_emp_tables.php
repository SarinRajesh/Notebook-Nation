    ...
    <div class="container-fluid">
      ...
      <div class="row mt-3" style="margin-right:-1207.5px">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
            <form action="records_employee.php" method="post">
    <button type="submit" class="button-7" name="download" style="margin-left: 1071px;">Download</button>
     </form>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr>
                    <?php
            $query="select * from dashboard where role = 'employee'";
            $result=mysqli_query($conn,$query);
            while($row=mysqli_fetch_array($result))
            {
                $_SESSION['id']=$row['id'];
                    ...
                    <?php if ($row['file']==NULL) {
                      ...
                      <td> <button class="btn btn-danger"><?php echo "<a href='dashboard_custstatus.php?id=$row[id]'>Deactivate</a>"?></button></td>
                      <?php } else {
                        ?><td style="color:red"><?php echo $row['status'];?></td>
                       <td> <button class="btn btn-success"><?php echo "<a href='dashboard_custstatus.php?id=$row[id]'>Activate</a>"?></button></td>
                      <?php }
                      ?>
                    </tr>
                    <?php
