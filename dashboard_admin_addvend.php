  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-6" style="margin-left: 271px;">
         <div class="card">
           <div class="card-body">
           <div class="card-title">Add Vendors</div>
           <hr>
...
if(isset($_POST["submit"]))
{
    ...
    $cfile=$_FILES["file"]["name"];
		...
		values('$name','$phone','$email','$username','$password','$cfile','active','vendor')";
		$result=mysqli_query($conn,$query);
		...
		if($result)
		{
			...
			?><script>
				   window.location.href = 'dashboard_admin_vendor_tables.php';
				</script>
				<?php
		}
	}
