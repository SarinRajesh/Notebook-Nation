...
if(isset($_POST["query"]))
{
	...
	$query = "
	SELECT order_tbl.order_id,order_tbl.lap_id,order_tbl.quantity,order_tbl.amount,order_tbl.city,order_tbl.district,order_tbl.state, order_tbl.order_date,order_tbl.order_status,
