        ...
        <div class="col-lg-6">
          <div class="card" style="width:103%">
            <div class="card-body" style="margin-left:-1%">
              <h5 class="card-title">Laptop Table</h5>
            ...
            while($row=mysqli_fetch_array($result))
            {
                $_SESSION['id']=$row['id'];
                      ...
                      <form action="" method="post">
                                <input type="hidden" name="update_price_id"  value="<?php echo $row['id']; ?>" >
                                <input style="width: 80px; height: 30px" type="number" name="update_price" min="1"  value="<?php echo $row['price']; ?>" >
                            </td>        
                       <td> <button  value="update"  class="button-7" name="update_update_btn" style="margin-left:-27px;">Update</button></td> 
                      </form>    
                      <td><?php echo $row['stock'];?></td>         
                     <!-- <td> <button  value="update" data-bs-toggle="modal" data-bs-target="#exampleModal" class="button-7" name="update_update_btn">Update</button></td> -->   
                      <td> <button class="btn btn-danger" style="margin-left: -38px;"><?php echo "<a href='dashboard_emplap_delete.php?id=$row[id]'>Remove</a>"?></button></td> 
                    </tr>
                    </tr>
                    <?php
                    }
