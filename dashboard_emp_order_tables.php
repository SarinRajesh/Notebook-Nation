            ...
            <div class="card-body" style="margin-left:-1%">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  FROM order_tbl
                  INNER JOIN laptops
                  ON order_tbl.lap_id = laptops.id ORDER BY order_tbl.order_date DESC";
                  ...
                  while($row = mysqli_fetch_array($result)){
                     ...
                     Laptop id : <?php echo $row['lap_id'];?></td>
                      ...
                      <?php if($row['order_status']=='Not confirmed') { ?>
                     <td style="color:skyblue"><?php echo $row['order_status'];?> </td>          
                      <td><button class="btn btn-success"><?php echo "<a href='dashboard_order_confirm.php?id=$row[order_id]'>Confirm</a>"?></button><br>
                   <button class="btn btn-danger" style="margin-top:10px;width:95px;"><?php echo "<a href='dashboard_order_cancel.php?id=$row[order_id]'>Cancel</a>"?></button></td>
                  
                   <?php } else if($row['order_status']=='Confirmed' and $row['delivery_status']=='Pending') { ?>
                     <td style="color:lightgreen"><?php echo $row['order_status'];?></td>           
                      <td><button class="btn btn-success" disabled><?php echo "<a href='dashboard_order_status.php?id=$row[order_id]'>Confirmed</a>"?></button><br>
                   <button class="btn btn-danger" style="margin-top:10px;width:115px;"><?php echo "<a href='dashboard_order_cancel.php?id=$row[order_id]'>Cancel</a>"?></button></td>
                      <?php } else if($row['order_status']=='Confirmed' and $row['delivery_status']=='Delivered') { ?>
                     <td style="color:lightgreen"><?php echo $row['order_status'];?></td>           
                      <td><button class="btn btn-success" disabled><?php echo "<a href='dashboard_order_status.php?id=$row[order_id]'>Delivered</a>"?></button><br>
                      <?php } else { ?>   
                        <td style="color:red"><?php echo $row['order_status'];?>  </td>
                  <td> <button class="btn btn-danger" disabled><?php echo "<a href='dashboard_order_status.php?id=$row[order_id]'>Cancelled</a>"?></button></td>
                 <?php } ?>
                    </tr>
                    </tr>
                    <?php
