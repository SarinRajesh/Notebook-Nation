...
if(isset($_POST["submit"]))
{
    ...
    $cfile=$_FILES["file"]["name"];
		...
		values('$name','$phone','$email','$username','$password','$cfile','active','employee')";
		$result=mysqli_query($conn,$query);
		...
		if($result)
		{
			...
			?><script>
				   window.location.href = 'dashboard_admin_emp_tables.php';
				</script>
				<?php
		}
	}
