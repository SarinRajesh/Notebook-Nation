 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="dashboard_delivery_boy_tables.php">
          <i class="zmdi zmdi-grid"></i> <span>Delivery Table</span>
        </a>
      </li>

      
      <li><a href="dashboard_delivery_boy_status.php"><i class="zmdi zmdi-coffee text-danger"></i> <span>Status change</span></a></li>  

      <li class="sidebar-header">PROFILE</li>

      <li>
        <a href="dashboard_delivery_boy_profile.php">
      ...
      <li>
        <a href="dashboard_delivery_boy_calendar.php">
...
if(isset($_POST['update_update_btn'])){
   ...
   $update_otp = $_POST['update_otp'];
  $update_id = $_POST['update_id'];

  $update_query = mysqli_query($conn, "UPDATE `order_tbl` SET delivery_status = '$update_status',otp = '$update_otp' WHERE order_id = '$update_id'");
  if($update_query){
     ?><script>window.locatio.href='dashboard_delivery_boy_tables.php';</script>
     <?php
  };
};
        ...
        <div class="col-lg-6">
          <div class="card" style="width:103%">
            <div class="card-body" style="margin-left:-1%">
              <h5 class="card-title">Table of Assigned Orders</h5>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  order_tbl.delivery_status,order_tbl.delivery_boy,order_tbl.otp,order_tbl.delivery_date,laptops.ram,laptops.storage,laptops.display,laptops.price
                  FROM order_tbl
                  INNER JOIN laptops
                  ON order_tbl.lap_id = laptops.id and order_status='Confirmed' and delivery_boy='$a'  ORDER BY order_tbl.order_date desc";
                  ...
                  while($row = mysqli_fetch_array($result)){
                    ...
                    Laptop id : <?php echo $row['lap_id'];?></td>
                      ...
                      <td>
                        <?php if($row['delivery_status']!='Delivered') { ?>
                          <form action="" method="post">
                                ...
                                <select style="width: 140px; height: 30px; background:white; color:black;" type="text" name="update_status" required>
                                <option style="background:white; color:black;" value="" disabled selected><?php echo $row['delivery_status']; ?></option>
                                <option style="background:white; color:black;" value="Out for delivery" required>Out for delivery</option>
                                <option style="background:white; color:black;" value="Delivered" required>Delivered</option>
                                <option style="background:white; color:black;" value="Delayed" required>Delayed</option>
                             
                                </select>
                      
                      <td> 
                                
                                <select style="width: 140px; height: 30px; background:white; color:black;" type="text" name="update_otp" required >
                                <option style="background:white; color:black;" value="" disabled selected><?php echo $row['otp']; ?></option>
                                <option style="background:white; color:black;" value="Verified" required>Verified</option>
                                <option style="background:white; color:black;" value="Not verified" required>Not verified</option>
                             
                                </select>
                          <button  value="update"  class="button-7" name="update_update_btn" style="margin-left:8px;">Update</button></td> 
                      </form>
                      <?php } else { ?>
                        <input type="hidden" name="update_id"  value="<?php echo $row['order_id']; ?>" >
                                
                                <select style="width: 140px; height: 30px; background:white; color:black;" type="text" name="update_status" disabled>
                                <option style="background:white; color:black;" value="" disabled selected><?php echo $row['delivery_status']; ?></option>
                                <option style="background:white; color:black;" value="Out for delivery" required>Out for delivery</option>
                                <option style="background:white; color:black;" value="Delivered" required>Delivered</option>
                                <option style="background:white; color:black;" value="Delayed" required>Delayed</option>
                      ...
                      <td> 
                                ...
                                <select style="width: 140px; height: 30px; background:white; color:black;" type="text" name="update_otp" disabled>
                                <option style="background:white; color:black;" value="" disabled selected><?php echo $row['otp']; ?></option>
                                <option style="background:white; color:black;" value="Verified" required>Verified</option>
                                <option style="background:white; color:black;" value="Not verified" required>Not verified</option>
                             
                                </select>
                          <button  value="update"  class="button-7" name="update_update_btn" style="margin-left:8px;" disabled>Delivered</button></td> 
