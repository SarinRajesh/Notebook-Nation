...
<nav class="navbar navbar-expand-lg">
        ...
        <section class="hero-section" id="section_1">
            ...
            <div class="container d-flex justify-content-center align-items-center" style="margin-top:17%;margin-left:50%">
            ...
            <div class="video-wrap">
                <video autoplay="" loop="" muted="" class="custom-video" poster="">
                    <source src="video/asus.mp4" type="video/mp4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-4 mb-lg-0 d-flex align-items-center">
                        <div class="services-info">
                            ...
                            <p class="text-white"> If you are confused about the authenticity of the Laptops you want to buy, then do not worry. At Notebook Nation,
                                the Laptops offered are of the best quality and we promise it is completely genuine.
                            The Laptops offered at Notebook Nation - the emerging online shopping store of India, are manufactured by some top
                            players in the market.</p>

                            <h6 class="text-white mt-4">Notebook Nation</h6>

                            <p class="text-white">Notebook Nation.in is the only official online portal authorized by NOTEBOOK NATION INDIA SALES PRIVATE LIMITED. Our
                                vision is to provide the best product discovery and shopping experience for our customers. Explore
                                Notebook Nation's various technologies, find details of new product launches, get details of the latest offers
                                and shop with the comfort and trust of buying genuine Notebook Nation Products.</p>
