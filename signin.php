...
<body>
    ...
    $(document).ready(function(){
            ...
            var mod3=0;
                            ...
                            {
                                mod4=1;
                            $('#text5').html('<span class="error">Username invalid</span>');
                            ...
                            var ad = /^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$/;
                            r_pswd=ad.test(password);
                            if (!r_pswd) {
                                            $("#text6").html("<span class='error'>Please enter a valid password</span>");
                                           mod5=1;
                                        } else {
                                            
                            $.ajax({
                            url:'passwordvalid.php',
                            method:"POST",
                            ...
                            if(data != '0')
                            {
                            $('#text6').html('<span class="text-success">Password valid</span>');
                            mod5=0;
                            }
                            else
                            {
                                mod5=1;
                            $('#text6').html('<span class="error">Password invalid</span>');
                            $('.button2').attr("disabled", false);
                            }
                            }
                            })
            ...
            <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="login__form">
                        <h3 style="margin-bottom:44px;"> Login</h3>
                        <form action="#" method="POST">
                            ...
                            <span id="text6" style="position: absolute;margin-top: -21px;"></span><p id="availability"></p>
                            <button type="submit" name="submit" id="submit" class="button2">Login Now</button>
                        </form>
                        <a href="changepassword.php" class="forget_pass">Forgot Your Password?</a>
                    </div>
                </div>
                ...
                <div class="col-lg-6 d-flex align-items-center justify-content-center">
                    <div class="login__register">
                        ...
                        <a href="signup.php" class="button2">Register Now</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6">
                        <!--<div class="login__social__links">
                            <span>or</span>
                            <ul>
                                <li><a href="https://www.facebook.com/login/" class="facebook"><i class="fa fa-facebook"></i> Sign in With
                                Facebook</a></li>
                                <li><a href="https://myaccount.google.com/" class="google"><i class="fa fa-google"></i> Sign in With Google</a></li>
                                <li><a href="https://twitter.com/login?lang=en" class="twitter"><i class="fa fa-twitter"></i> Sign in With Twitter</a>
                                </li>
                            </ul>
                            </div>
                    -->
...
if(isset($_POST["submit"]))
{
    ...
    $password=$_POST["password"];
        ...
        $query="select * from reg where username='$username' && password='$password' && status='active' && role='customer'";
		...
		if($count>0)
		{
	       ...
	       ?><script>
				   window.location.href = 'homeaccount.php';
				</script>
				<?php
              
		}
        else{
           ?> <div style="color:red;margin-top: -283px;margin-left: -184px;">Username and Password doesnot match</div>
       <?php }
