    ...
    <div class="container-fluid">
      ...
      <div class="row mt-3" style="margin-right:-1207.5px">
        ...
        <div class="col-lg-6">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Delivery boys Table</h5>
            ...
            while($row=mysqli_fetch_array($result))
            {
                $_SESSION['id']=$row['id'];
                     ...
                     <?php if ($row['file']==NULL) {
                        ?>
                       <td><img class="rounded-circle me-lg-2" src="./images/prof.png" alt="" style="width: 40px; height: 40px;"></td>
                       <?php } else {
                        ?>
                       <td><img class="rounded-circle me-lg-2" src="./uploads/<?php echo $row['file']; ?>" alt="" style="width: 40px; height: 40px;"></td>
                       <?php }
                      ?>
                      ...
                      { ?><td style="color:red">Not available</td>
                        <td> <button class="btn btn-success"><?php echo "<a href='dashboard_delivery_boy_changestatus.php?id=$row[id]'>Change</a>"?></button></td>
                       <?php }
                      else {
                        
                      ?>  <td style="color:lightgreen">available</td>             
                      <td> <button class="btn btn-danger"><?php echo "<a href='dashboard_delivery_boy_changestatus.php?id=$row[id]'>Change</a>"?></button></td>
                      <?php } 
                      ?>
                    </tr>
                    <?php
