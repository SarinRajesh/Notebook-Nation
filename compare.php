...
if (isset($_GET['product_id']) && !empty($_GET['product_id'])) {
    ...
    $delete_product = mysqli_query($conn, "DELETE FROM `compare` WHERE id = '$product_id'");
...
<?php
 $query = "SELECT * FROM compare where person='$a'";				
$result = mysqli_query($conn, $query);
...
?>
    ...
    <div class=" col-xs-6">
            <div class="product" style="width: 408px;margin:39px 26px" >
                <?php echo "<a href='view.php?product_id=$row[lap_id]'>"?><div class="product-img" style="height:382px;">
                ...
                <div class="product-body" >
                    ...
                    <h3 class="product-name">1 Year Onsite Warranty</h3>
                    <h3 class="product-name">7 Days Replacement Policy</h3>
                    ...
                    <button class="button-62" style=" margin-top: 10px;"><?php echo "<a style='color:white' href='compare.php?product_id=$row[id]'>Remove</a>"?></button>
